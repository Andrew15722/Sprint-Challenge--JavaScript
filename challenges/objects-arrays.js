...
console.log(`How much did tyrannosaurus weigh? ${tyrannosaurus.weight}`);

// What was the diet of a velociraptor?
console.log(`What was the diet of a velociraptor? ${velociraptor.diet}`);

// How long was a stegosaurus?
console.log(`How long was a stegosaurus? ${stegosaurus.length}`);

// What time period did tyrannosaurus live in?
console.log(`What time period did tyrannosaurus live in? ${tyrannosaurus.period}`);
...
const universities = graduates.map(function(obj) {
...
for (i = 0; i < universities.length; i++) {
	if (universities[i].includes('Uni') == true || universities[i].includes('uni') == true) {
...
zooAnimals.forEach((obj) => animalNames.push(`name: ${obj.animal_name}, scientific: ${obj.scientific_name}`));
...
//   if(obj.population < 5 === true) {
//     return lowerPopulation.push(obj.animal_name);
//   }
// });

//arrow function conversion
zooAnimals.filter((obj) => {
	if (obj.population < 5 === true) {
		return lowerPopulation.push(obj.animal_name);
	}
});
...
*/
//arrow function conversion
const populationTotal = zooAnimals.reduce((total, obj, index, array) => {
